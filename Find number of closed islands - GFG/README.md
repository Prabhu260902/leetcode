...
<p><span style="font-size: 18px;"><strong>Note:</strong> A closed island is known as the group of <strong>1s</strong> that are surrounded by only <strong>0s</strong> on all the boundaries <strong>(except diagonals)</strong>. In simple words closed island is the island whose none of the <strong>1s</strong> lie on the edges of the matrix.</span></p>
